...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task1()
        {
            ...
            //Query syntax
            // IEnumerable<Emp> result = from e in Emps where e.Job == "Background programmer" select e;
            //Method syntax
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Depts.
                GroupJoin(Emps, de => de.Deptno, e => e.Deptno, 
                    (de, emps) => new
                    {
                        name = de.Dname,
                        numOfEmployees = emps.Count()
                    }).
                Where(des => des.numOfEmployees > 1);
            return result;
        }
        ...
        {
            // Emps1 => Empno
            // Emps2 => Empno = Mgr?.Empno

            // ???
            IEnumerable<Emp> result = Emps.TaskMgrHelper();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                .GroupJoin(Emps, de => de.Deptno, e => e.Deptno, (de, e) => new
                {
                    Deptss = de,
                    Empss = e.Count()
                })
                .Where(x => x.Empss is 5 or 0)
                .Select(x => x.Deptss);
            //result =
            return result;
        }
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> TaskMgrHelper(this IEnumerable<Emp> employees)
        {
            return employees.Where(e1 => employees.Any(e2 => e2.Mgr?.Empno == e1.Empno)).OrderBy(e => e.Ename)
